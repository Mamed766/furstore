    ...
    <div className="max-w-screen-xl mx-auto mt-10">
      <div>
        <div className="flex flex-col  justify-center items-center">
          <h2 className="text-[30px] font-semibold">Best Sellers</h2>
        ...
        <div className="flex arrival__mobile  gap-2 items-center ">
          ...
          <div className="h-[53rem] max-w-[20rem] overflow-hidden relative">
            <img
              src="https://vinova-furstore.myshopify.com/cdn/shop/files/img-9-9_580x.jpg?v=1703739529"
